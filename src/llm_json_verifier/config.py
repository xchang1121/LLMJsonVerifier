...
class ServiceSettings(StrictConfig):
    ...
    max_schema_bytes: int = Field(default=65_536, ge=256, le=1_048_576)
    max_schema_depth: int = Field(default=8, ge=1, le=32)
    max_schema_nodes: int = Field(default=512, ge=1, le=8192)
